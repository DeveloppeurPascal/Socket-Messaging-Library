...
D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://socketmessaging.developpeur-pascal.fr/) ou [le devlog du projet](https://developpeur-pascal.fr/socket-messaging-library.html).
